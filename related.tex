...
But, we take a more flexible and descriptive \orange{two-stack} attention mechanism, \orange{one stack} for fact embedding, and the other one for article embedding which is  dynamically generated for each instance according to the fact-side clues as extra guidance.
