...
In our proposed method, however, we jointly model the charge prediction and relevant article extraction in a single framework, which enables them to influence each other \orange{in a positive way}.
...
Circle 1, 2 and 3 refers to the clauses that usually indicates the start of the facts part, the court view part and the sentence part respectively.
}
