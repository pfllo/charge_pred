...
The results are summarized in Table \ref{tabble_main_results}. 
...
% \end{table}
Our top $k$ article extractor achieves 77.60\%, 88.96\%, 94.21\% and 96.53\% recall for the top 5, 10, 20 and 30 results respectively.
