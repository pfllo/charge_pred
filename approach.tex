...
\orange{Similar to the preliminary classification phase of \cite{liu2015predicting},}
...
\orange{Although the order of the top $k$ extracted articles is not fully reliable, \cite{vinyals2016matching} suggests it is still beneficial to embed the context of each element in a set, where the order does not even exist, using a bi-directional RNN.}
